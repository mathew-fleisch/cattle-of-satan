...
echo -e " │ A────┼───┼───┼───┼───┼── ${CVA06}${VA06}${NC}${CEA06}${EA06}${NC}${CVA07}${VA07}${NC} ──┼───┼───┼───┼───┼───A                 │"
echo -e " │      │   │   │   │   │  ${CEB05}${EB05}${NC}     ${CEB07}${EB07}${NC}  │   │   │   │   │                     │"
echo -e " │      │   │   │   │   │ ${CEB05}${EB05}${NC} ${CTB06}${TB06}${NC}XXXXX ${CEB07}${EB07}${NC} │   │   │   │   │                     │"
echo -e " │ B────┼───┼───┼─  ${CVB04}${VB04}${NC}${CEB04}${EB04}${NC}${CVB05}${VB05}${NC}${CEB05}${EB05}${NC}  ${CTB06}${TB06}${NC}YYYYY  ${CEB07}${EB07}${NC}${CVB08}${VB08}${NC}${CEB08}${EB08}${NC}${CVB09}${VB09}${NC} ──┼───┼───┼───B                 │"
...
echo -e " │ C────┼─  ${CVC02}${VC02}${NC}${CEC02}${EC02}${NC}${CVC03}${VC03}${NC}${CEC03}${EC03}${NC}  ${CTB06}${TB06}${NC}YYYYY  ${CEC05}${EC05}${NC}${CVC06}${VC06}${NC}${CEC06}${EC06}${NC}${CVC07}${VC07}${NC}${CEC07}${EC07}${NC}  ${CTB06}${TB06}${NC}YYYYY  ${CEC09}${EC09}${NC}${CVC10}${VC10}${NC}${CEC10}${EC10}${NC}${CVC11}${VC11}${NC} ──┼───C                 │"
...
echo -e " │ D─── ${CVD01}${VD01}${NC}${CED01}${ED01}${NC}  ${CTB06}${TB06}${NC}YYYYY  ${CED03}${ED03}${NC}${CVD04}${VD04}${NC}${CED04}${ED04}${NC}${CVD05}${VD05}${NC}${CED05}${ED05}${NC}  ${CTB06}${TB06}${NC}YYYYY  ${CED07}${ED07}${NC}${CVD08}${VD08}${NC}${CED08}${ED08}${NC}${CVD09}${VD09}${NC}${CED09}${ED09}${NC}  ${CTB06}${TB06}${NC}YYYYY  ${CED11}${ED11}${NC}${CVD12}${VD12}${NC}───D                 │"
...
echo -e " │ E────┼─ ${CEE01}${EE01}${NC}${CVE02}${VE02}${NC}${CEE02}${EE02}${NC}${CVE03}${VE03}${NC}${CEE03}${EE03}${NC}  ${CTB06}${TB06}${NC}YYYYY  ${CEE05}${EE05}${NC}${CVE06}${VE06}${NC}${CEE06}${EE06}${NC}${CVE07}${VE07}${NC}${CEE07}${EE07}${NC}  ${CTB06}${TB06}${NC}YYYYY  ${CEE09}${EE09}${NC}${CVE10}${VE10}${NC}${CEE10}${EE10}${NC}${CVE11}${VE11}${NC}${CEE11}${EE11}${NC} ─┼───E                 │"
...
echo -e " │ F─── ${CVF01}${VF01}${NC}${CEF01}${EF01}${NC}  ${CTB06}${TB06}${NC}YYYYY  ${CEF03}${EF03}${NC}${CVF04}${VF04}${NC}${CEF04}${EF04}${NC}${CVF05}${VF05}${NC}${CEF05}${EF05}${NC}  ${CTB06}${TB06}${NC}YYYYY  ${CEF07}${EF07}${NC}${CVF08}${VF08}${NC}${CEF08}${EF08}${NC}${CVF09}${VF09}${NC}${CEF09}${EF09}${NC}  ${CTB06}${TB06}${NC}YYYYY  ${CEF11}${EF11}${NC}${CVF12}${VF12}${NC}───F                 │"
...
echo -e " │ G────┼─ ${CEG01}${EG01}${NC}${CVG02}${VG02}${NC}${CEG02}${EG02}${NC}${CVG03}${VG03}${NC}${CEG03}${EG03}${NC}  ${CTB06}${TB06}${NC}YYYYY  ${CEG05}${EG05}${NC}${CVG06}${VG06}${NC}${CEG06}${EG06}${NC}${CVG07}${VG07}${NC}${CEG07}${EG07}${NC}  ${CTB06}${TB06}${NC}YYYYY  ${CEG09}${EG09}${NC}${CVG10}${VG10}${NC}${CEG10}${EG10}${NC}${CVG11}${VG11}${NC}${CEG11}${EG11}${NC} ─┼───G                 │"
...
echo -e " │ H─── ${CVH01}${VH01}${NC}${CEH01}${EH01}${NC}  ${CTB06}${TB06}${NC}YYYYY  ${CEH03}${EH03}${NC}${CVH04}${VH04}${NC}${CEH04}${EH04}${NC}${CVH05}${VH05}${NC}${CEH05}${EH05}${NC}  ${CTB06}${TB06}${NC}YYYYY  ${CEH07}${EH07}${NC}${CVH08}${VH08}${NC}${CEH08}${EH08}${NC}${CVH09}${VH09}${NC}${CEH09}${EH09}${NC}  ${CTB06}${TB06}${NC}YYYYY  ${CEH11}${EH11}${NC}${CVH12}${VH12}${NC}───H                 │"
...
echo -e " │ I────┼6 ${CEI01}${EI01}${NC}${CVI02}${VI02}${NC}${CEI02}${EI02}${NC}${CVI03}${VI03}${NC}${CEI03}${EI03}${NC}  ${CTB06}${TB06}${NC}YYYYY  ${CEI05}${EI05}${NC}${CVI06}${VI06}${NC}${CEI06}${EI06}${NC}${CVI07}${VI07}${NC}${CEI07}${EI07}${NC}  ${CTB06}${TB06}${NC}YYYYY  ${CEI09}${EI09}${NC}${CVI10}${VI10}${NC}${CEI10}${EI10}${NC}${CVI11}${VI11}${NC}${CEI11}${EI11}${NC} 7│───I                 │"
...
echo -e " │ J────┼───┼───┼─ ${CEJ03}${EJ03}${NC}${CVJ04}${VJ04}${NC}${CEJ04}${EJ04}${NC}${CVJ05}${VJ05}${NC}${CEJ05}${EJ05}${NC}  ${CTB06}${TB06}${NC}YYYYY  ${CEJ07}${EJ07}${NC}${CVJ08}${VJ08}${NC}${CEJ08}${EJ08}${NC}${CVJ09}${VJ09}${NC}${CEJ09}${EJ09}${NC} ─┼───┼───┼───J                 │"
echo -e " │      │   │   │   │P8  ${CEK05}${EK05}${NC}  ${CTB06}${TB06}${NC}ZZZZZ  ${CEK07}${EK07}${NC}  P9│   │   │   │                     │"
echo -e " │      │   │   │   │   │ ${CEK05}${EK05}${NC}       ${CEK07}${EK07}${NC} │   │   │   │   │                     │"
echo -e " │ K────┼───┼───┼───┼───┼─ ${CEK05}${EK05}${NC}${CVK06}${VK06}${NC}${CEK06}${EK06}${NC}${CVK07}${VK07}${NC}${CEK07}${EK07}${NC} ─┼───┼───┼───┼───┼───K                 │"
echo -e " │      │   │   │   │   │   │   │   │   │   │   │   │                     │"
